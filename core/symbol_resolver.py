...
class ImportGraph:
    ...
    def add_import(self, module_name: str, symbol: str, alias: Optional[str] = None):
    ...
    def get_actual_symbol(self, alias: str) -> Optional[str]:
    ...
    def get_module_for_symbol(self, symbol: str) -> Optional[str]:
...
class SymbolResolver:
    ...
    def _index_symbols(self) -> None:
        ...
        try:
            ...
            for node, scope in scope_map.items():
                qualname = qualname_map.get(node)
    ...
    def _get_enclosing_class(self, scope) -> Optional[str]:
        return None
    ...
    ) -> Optional[Tuple[cst.CSTNode, Symbol]]:
...
class ScopeAwareTransformer(cst.CSTTransformer):
    ...
    def _get_call_context(self, call_node: cst.Call) -> Optional[str]:
