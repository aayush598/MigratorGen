...
from .changelog_parser import ChangeType, MigrationRule, RuleWhenCondition
    ...
    def validate(self, rule: MigrationRule, report: ValidationReport):
        ...
        for field in self.required_fields:
            if field not in rule_dict or rule_dict[field] == "":
                report.errors.append(ValidationMessage(
                    rule_id=rule.id,
...
class RenameFunctionValidator(BaseRuleValidator):
    ...
    forbidden_fields: Set[str] = {
        "old_module", "new_module", "decorator_name", "function_name",
        "argument_name", "new_argument_name", "default_value", "argument_position",
        "new_order", "replacement", "removal_version", "source_module", "target_module",
    }

    def custom_validate(self, rule: MigrationRule, report: ValidationReport):
        if rule.old_name == rule.new_name:
            report.warnings.append(ValidationMessage(
                rule_id=rule.id,
    ...
    def _validate_identifier(self, value: Optional[str], field: str, rule: MigrationRule, report: ValidationReport):
...
class AddArgumentValidator(BaseRuleValidator):
    ...
    forbidden_fields: Set[str] = {
        "old_name", "new_name", "old_module", "new_module", "decorator_name",
        "new_argument_name", "new_order", "replacement", "removal_version",
...
class RemoveArgumentValidator(BaseRuleValidator):
    ...
    forbidden_fields: Set[str] = {
        "old_name", "new_name", "old_module", "new_module", "decorator_name",
        "new_argument_name", "default_value", "new_order", "replacement",
        "removal_version", "source_module", "target_module",
    }
    reversible = False
...
class RenameClassValidator(BaseRuleValidator):
    ...
    forbidden_fields: Set[str] = {
        "old_module", "new_module", "decorator_name", "function_name",
        "argument_name", "new_argument_name", "default_value", "new_order",
        "replacement", "removal_version", "source_module", "target_module",
    }
...
class RenameImportValidator(BaseRuleValidator):
    ...
    forbidden_fields: Set[str] = {
        "decorator_name", "function_name", "argument_name", "new_argument_name",
        "default_value", "new_order", "replacement", "removal_version",
        "source_module", "target_module",
    }
    ...
    def _validate_module_path(self, value: Optional[str], field: str, rule: MigrationRule, report: ValidationReport):
...
class ChangeArgumentDefaultValidator(BaseRuleValidator):
    ...
    forbidden_fields: Set[str] = {
        "old_name", "new_name", "old_module", "new_module", "decorator_name",
        "new_argument_name", "new_order", "replacement",
        "removal_version", "source_module", "target_module",
    }
...
class ReorderArgumentsValidator(BaseRuleValidator):
    ...
    forbidden_fields: Set[str] = {
        "old_name", "new_name", "old_module", "new_module", "decorator_name",
        "argument_name", "new_argument_name", "default_value", "replacement",
        "removal_version", "source_module", "target_module",
    }
...
class DeprecateFunctionValidator(BaseRuleValidator):
    ...
    forbidden_fields: Set[str] = {
        "new_name", "old_module", "new_module", "decorator_name", "function_name",
        "argument_name", "new_argument_name", "default_value", "new_order",
        "source_module", "target_module",
    }
...
class AddDecoratorValidator(BaseRuleValidator):
    ...
    forbidden_fields: Set[str] = {
        "old_name", "new_name", "old_module", "new_module", "argument_name",
        "new_argument_name", "default_value", "new_order", "replacement",
        "removal_version", "source_module", "target_module",
    }
...
class RuleValidator:
    def validate_rule(self, rule: MigrationRule, report: ValidationReport):
        ...
        if not validator.reversible and not rule.reversible:
            report.info.append(ValidationMessage(
                rule_id=rule.id,
