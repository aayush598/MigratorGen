...
class RuleWhenCondition(BaseModel):
    ...
    not_imported_from: str | None = None
    inside_class: str | list[str] | None = None
    outside_class: bool | None = None
    inside_function: str | list[str] | None = None
    python_version: str | None = None
    min_python_version: str | None = None
    max_python_version: str | None = None
    has_decorator: str | None = None
    lacks_decorator: str | None = None
    returns_type: str | None = None
    called_from_module: str | None = None
    called_as_method: bool | None = None
