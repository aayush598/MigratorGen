...
class RenameFunctionValidator(BaseRuleValidator):
    ...
    def _validate_identifier(self, value: str | None, field: str, rule: MigrationRule, report: ValidationReport):
...
class RenameImportValidator(BaseRuleValidator):
    ...
    def _validate_module_path(self, value: str | None, field: str, rule: MigrationRule, report: ValidationReport):
